...
namespace OpenTracingSample
{
    public class OpenTracingContextLogEventEnricher : ILogEventEnricher
    {
        public void Enrich(LogEvent logEvent, ILogEventPropertyFactory propertyFactory)
        {
            ...
            logEvent.AddPropertyIfAbsent(propertyFactory.CreateProperty("OpenTracingTraceId", tracer.ActiveSpan.Context.TraceId));
            logEvent.AddPropertyIfAbsent(propertyFactory.CreateProperty("OpenTracingSpanId", tracer.ActiveSpan.Context.SpanId));
        }
    }
